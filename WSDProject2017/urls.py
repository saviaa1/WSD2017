...
urlpatterns = [
    ...
    path('<int:object_id>/delete_game/', developerviews.deleting, name='delete_game'),
    path('profile/', developerviews.profile, name='profile'),
    path('<int:object_id>/edit_game/', developerviews.editing, name='edit_game'),
    path('oauth/', include('social_django.urls', namespace='social')),
    path('profile/password/', developerviews.password, name='password'),
    path('profile/<int:object_id>/', developerviews.statistics, name='statistics'),
