...
**Deploying to Heroku**  
Surprisingly, this was perhaps one of the more challenging parts of the project. Even though we started doing this project from Django's Heroku template, we still had problems deploying it.
...
You can connect to your social media trough the profile page. Additionally, you can share the games on twitter on the game page.
